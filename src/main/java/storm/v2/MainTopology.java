...
import storm.v2.input.InputSpout;
import storm.v2.level0.FinalBolt;
import storm.v2.output.OutputBolt;
...
public class MainTopology {
    ...
    public void topology() {
        ...
        topologyBuilder.setBolt("final-bolt", new FinalBolt(), NUM_FINALBOLT).shuffleGrouping("input-spout");

...
import storm.v3.input.InputSpout;
import storm.v3.level0.Level0Bolt;
import storm.v3.level1.FinalBolt;
import storm.v3.output.OutputBolt;
...
public class MainTopology {
    ...
    public void topology() {
        ...
        topologyBuilder.setBolt("final-bolt", new FinalBolt(), NUM_FINALBOLT).shuffleGrouping("level0-bolt");
